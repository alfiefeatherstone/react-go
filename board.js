...
/*
 *  Returns a size x size matrix with all entries initialiazed to Board.EMPTY
 */
...
/*
 *  At any point a player can pass and let their opponent play
 */
...
/*
 *  Attempt to place a stone a (i,j). Returns true if move was legal.
 */
